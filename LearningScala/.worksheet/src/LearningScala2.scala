object LearningScala2 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(141); 
  ...
  do { println(x); x+=1 } while (x <= 10);$skip(154); val res$0 = 
   ...
   {val x = 10; x + 20};System.out.println("""res0: Int = """ + $show(res$0));$skip(82); 
	 ...
	 var counter=0;System.out.println("""counter  : Int = """ + $show(counter ));$skip(19); 
	 var a=0; var b=1;System.out.println("""a  : Int = """ + $show(a ));System.out.println("""b  : Int = """ + $show(b ));$skip(35); 
	 var fsResult : String = "0, 1, ";System.out.println("""fsResult  : String = """ + $show(fsResult ));$skip(176); 
	 
	// println("the result should be " + fsResult)
   while (counter < 10){
	 val c= a + b
	 a=b; b = c;
	 counter = counter + 1
	 fsResult = fsResult + c.toString() +", "
	 };$skip(23); 
    println (fsResult)}
