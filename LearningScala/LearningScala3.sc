object LearningScala3 {
  ...
  s.toUpperCase()
  }                                               //> strUP: (s: String)String
  
  println(strUP("foo"))                           //> FOO
  
  def transformStr(s: String, sp: String => String) : String ={
  sp(s)
  }                                               //> transformStr: (s: String, sp: String => String)String
  
 transformStr("foo", strUP)                       //> res3: String = FOO
  
 transformStr("foo", s => s.toUpperCase())        //> res4: String = FOO
 
 transformStr("foo", x => x.toUpperCase())        //> res5: String = FOO
